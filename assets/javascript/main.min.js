...
(function(e) {
    e.address = function() {
        var t = function(t) {
            ...
            i = function() {
                e().unbind.apply(e(e.address), Array.prototype.slice.call(arguments));
                return e.address
            },
            s = function() {
                return B.pushState && A.state !== w
            },
            o = function() {
                return ("/" + j.pathname.replace(new RegExp(A.state), "") + j.search + (u() ? "#" + u() : "")).replace(q, "/")
            },
            u = function() {
                var e = j.href.indexOf("#");
                return e != -1 ? j.href.substr(e + 1) : ""
            },
            a = function() {
                return s() ? o() : u()
            },
            ...
            p = function() {
                if (!V) {
                    var e = a();
                    if (decodeURI(Q) != decodeURI(e))
                        if (D && M < 7) j.reload();
                        else {
                            D && !R && A.history && I(m, 50);
                            Q = e;
                            d(L)
                        }
                }
            ...
            d = function(e) {
                I(v, 10);
                return t(T).isDefaultPrevented() || t(e ? N : C).isDefaultPrevented()
            },
            v = function() {
                if (A.tracker !== "null" && A.tracker !== E) {
                    var t = e.isFunction(A.tracker) ? A.tracker : P[A.tracker],
                        n = (j.pathname + j.search + (e.address && !s() ? e.address.value() : "")).replace(/\/\//, "/").replace(/^\/$/, "");
                    e.isFunction(t) ? t(n) : e.isFunction(P.urchinTracker) ? P.urchinTracker(n) : P.pageTracker !== w && e.isFunction(P.pageTracker._trackPageview) ? P.pageTracker._trackPageview(n) : P._gaq !== w && e.isFunction(P._gaq.push) && P._gaq.push(["_trackPageview", decodeURI(n)])
                }
            },
            m = function() {
                var e = f() + ":" + L + ";document.open();document.writeln('<html><head><title>" + H.title.replace(/\'/g, "\\'") + "</title><script>var " + S + ' = "' + encodeURIComponent(a()).replace(/\'/g, "\\'") + (H.domain != j.hostname ? '";document.domain="' + H.domain : "") + "\";</script></head></html>');document.close();";
                M < 7 ? U.src = e : U.contentWindow.location.replace(e)
            },
            g = function() {
                if (z && W != -1) {
                    var e, t, n = z.substr(W + 1).split("&");
                    for (e = 0; e < n.length; e++) {
                        t = n[e].split("=");
                        /^(autoUpdate|history|strict|wrap)$/.test(t[0]) && (A[t[0]] = isNaN(t[1]) ? /^(true|yes)$/i.test(t[1]) : parseInt(t[1], 10) !== 0);
            ...
            y = function() {
                if (!$) {
                    $ = k;
                    g();
                    e('a[rel*="address:"]').address();
                    if (A.wrap) {
                        var n = e("body");
                        e("body > *").wrapAll('<div style="padding:' + (h(n, "marginTop") + h(n, "paddingTop")) + "px " + (h(n, "marginRight") + h(n, "paddingRight")) + "px " + (h(n, "marginBottom") + h(n, "paddingBottom")) + "px " + (h(n, "marginLeft") + h(n, "paddingLeft")) + 'px;" />').parent().wrap('<div id="' + S + '" style="height:100%;overflow:auto;position:relative;' + (_ && !window.statusbar.visible ? "resize:both;" : "") + '" />');
                        e("html, body").css({
                            height: "100%",
                            margin: 0,
                            padding: 0,
                        ...
                        _ && e('<style type="text/css" />').appendTo("head").text("#" + S + "::-webkit-resizer { background-color: #fff; }")
                    }
                    if (D && !R) {
                        n = H.getElementsByTagName("frameset")[0];
                        U = H.createElement((n ? "" : "i") + "frame");
                        U.src = f() + ":" + L;
                        if (n) {
                            n.insertAdjacentElement("beforeEnd", U);
                            n[n.cols ? "cols" : "rows"] += ",0";
                            U.noResize = k;
                            U.frameBorder = U.frameSpacing = 0
                        } else {
                            U.style.display = "none";
                            U.style.width = U.style.height = 0;
                            U.tabIndex = -1;
                            H.body.insertAdjacentElement("afterBegin", U)
                        }
                        I(function() {
                            e(U).bind("load", function() {
                                var e = U.contentWindow;
                                Q = e[S] !== w ? e[S] : "";
                                if (Q != a()) {
                                    d(L);
                                    j.hash = Q
                    ...
                    s() || (D && M > 7 || !D && R ? P.addEventListener ? P.addEventListener(x, p, L) : P.attachEvent && P.attachEvent("on" + x, p) : F(p, 50));
                    "state" in window.history && e(window).trigger("popstate")
                }
            },
            b = function(e) {
                e = e.toLowerCase();
            ...
            M = parseFloat(O.version),
            _ = O.webkit || O.safari,
            D = !e.support.opacity,
            P = function() {
                try {
                    return top.document !== w && top.document.title !== w ? top : window
                } catch (e) {
                    return window
                }
            }(),
        ...
        var R = "on" + x in P,
            ...
            Q = a();
        if (D) {
            M = parseFloat(O.substr(O.indexOf("MSIE") + 4));
            H.documentMode && H.documentMode != M && (M = H.documentMode != 8 ? 7 : 8);
            var G = H
                .onpropertychange;
            H.onpropertychange = function() {
                G && G.call(H);
                H.title != X && H.title.indexOf("#" + a()) != -1 && (H.title = X)
            }
        }
        B.navigationMode && (B.navigationMode = "compatible");
        if (document.readyState == "complete") var Y = setInterval(function() {
            if (e.address) {
                y();
                clearInterval(Y)
            }
        ...
        e(window).bind("popstate", function() {
            if (decodeURI(Q) != decodeURI(a())) {
                Q = a();
                d(L)
            }
        }).bind("unload", function() {
            P.removeEventListener ? P.removeEventListener(x, p, L) : P.detachEvent && P.detachEvent("on" + x, p)
        });
        return {
            bind: function() {
            ...
            unbind: function() {
                return i.apply(this, n(arguments))
            },
            init: function() {
            ...
            state: function(e) {
                if (e !== w) {
                    A.state = e;
                    var t = o();
                    A.state !== w && (B.pushState ? t.substr(0, 3) == "/#/" && j.replace(A.state.replace(/^\/$/, "") + t.substr(2)) : t != "/" && t.replace(/^\/#/, "") != u() && I(function() {
            ...
            title: function(e) {
                if (e !== w) {
                    I(function() {
                        X = H.title = e;
                        if (J && U && U.contentWindow && U.contentWindow.document) {
                            U.contentWindow.document.title = e;
                            J = L
                        }
                    }, 50);
                    return this
            ...
            value: function(e) {
                if (e !== w) {
                    ...
                    if (A.autoUpdate || K) {
                        if (d(k)) return this;
                        if (s()) B[A.history ? "pushState" : "replaceState"]({}, "", A.state.replace(/\/$/, "") + (Q === "" ? "/" : Q));
                        else {
                            V = k;
                            _ ? A.history ? j.hash = "#" + Q : j.replace("#" + Q) : Q != a() && (A.history ? j.hash = "#" + Q : j.replace("#" + Q));
                            D && !R && A.history && I(m, 50);
                            _ ? I(function() {
                                V = L
                            }, 1) : V = L
            ...
            path: function(e) {
                ...
                return l(Q).split("#")[0].split("?")[0]
            },
            pathNames: function() {
                var e = this.path(),
                    t = e.replace(q, "/").split("/");
                (e.substr(0, 1) == "/" || e.length === 0) && t.splice(0, 1);
            ...
            parameter: function(t, n, r) {
                ...
                if (n !== w) {
                    ...
                    s = [];
                    n = n === w || n === E ? "" : n.toString();
                    for (i = 0; i < o.length; i++) {
                        var u = o[i],
                            a = this.parameter(u);
                        typeof a == "string" && (a = [a]);
                        u == t && (a = n === E || n === "" ? [] : r ? a.concat([n]) : [n]);
                        for (var f = 0; f < a.length; f++) s.push(u + "=" + a[f])
                    }
                    e.inArray(t, o) == -1 && n !== E && n !== "" && s.push(t + "=" + n);
    ...
    e.fn.address = function(t) {
        this.data("address") || this.on("click", function(n) {
            if (n.shiftKey || n.ctrlKey || n.metaKey || n.which == 2) return !0;
            var r = n.currentTarget;
            if (e(r).is("a")) {
                n.preventDefault();
                n = t ? t.call(r) : /address:/.test(e(r).attr("rel")) ? e(r).attr("rel").split("address:")[1].split(" ")[0] : e.address.state() !== undefined && !/^\/?$/.test(e.address.state()) ? e(r).attr("href").replace(new RegExp("^(.*" + e.address.state() + "|\\.)"), "") : e(r).attr("href").replace(/^(#\!?|\.)/, "");
                e.address.value(n)
            }
            ...
            if (e(r).is("form")) {
                n.preventDefault();
                n = e(r).attr("action");
                r = t ? t.call(r) : (n.indexOf("?") != -1 ? n.replace(/&$/, "") : n + "?") + e(r).serialize();
                e.address.value(r)
            }
        }).data("address", !0);
        return this
